...
const (
	BuildQueueState_GetOperation_FullMethodName           = "/bonanza.buildqueuestate.BuildQueueState/GetOperation"
	BuildQueueState_ListOperations_FullMethodName         = "/bonanza.buildqueuestate.BuildQueueState/ListOperations"
	BuildQueueState_KillOperations_FullMethodName         = "/bonanza.buildqueuestate.BuildQueueState/KillOperations"
	BuildQueueState_ListPlatformQueues_FullMethodName     = "/bonanza.buildqueuestate.BuildQueueState/ListPlatformQueues"
	BuildQueueState_ListInvocationChildren_FullMethodName = "/bonanza.buildqueuestate.BuildQueueState/ListInvocationChildren"
	BuildQueueState_ListQueuedOperations_FullMethodName   = "/bonanza.buildqueuestate.BuildQueueState/ListQueuedOperations"
	BuildQueueState_ListWorkers_FullMethodName            = "/bonanza.buildqueuestate.BuildQueueState/ListWorkers"
	BuildQueueState_TerminateWorkers_FullMethodName       = "/bonanza.buildqueuestate.BuildQueueState/TerminateWorkers"
	BuildQueueState_ListDrains_FullMethodName             = "/bonanza.buildqueuestate.BuildQueueState/ListDrains"
	BuildQueueState_AddDrain_FullMethodName               = "/bonanza.buildqueuestate.BuildQueueState/AddDrain"
	BuildQueueState_RemoveDrain_FullMethodName            = "/bonanza.buildqueuestate.BuildQueueState/RemoveDrain"
)
...
func (c *buildQueueStateClient) GetOperation(ctx context.Context, in *GetOperationRequest, opts ...grpc.CallOption) (*GetOperationResponse, error) {
	...
	err := c.cc.Invoke(ctx, BuildQueueState_GetOperation_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *buildQueueStateClient) ListOperations(ctx context.Context, in *ListOperationsRequest, opts ...grpc.CallOption) (*ListOperationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, BuildQueueState_ListOperations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *buildQueueStateClient) KillOperations(ctx context.Context, in *KillOperationsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	...
	err := c.cc.Invoke(ctx, BuildQueueState_KillOperations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *buildQueueStateClient) ListPlatformQueues(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*ListPlatformQueuesResponse, error) {
	...
	err := c.cc.Invoke(ctx, BuildQueueState_ListPlatformQueues_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *buildQueueStateClient) ListInvocationChildren(ctx context.Context, in *ListInvocationChildrenRequest, opts ...grpc.CallOption) (*ListInvocationChildrenResponse, error) {
	...
	err := c.cc.Invoke(ctx, BuildQueueState_ListInvocationChildren_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *buildQueueStateClient) ListQueuedOperations(ctx context.Context, in *ListQueuedOperationsRequest, opts ...grpc.CallOption) (*ListQueuedOperationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, BuildQueueState_ListQueuedOperations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *buildQueueStateClient) ListWorkers(ctx context.Context, in *ListWorkersRequest, opts ...grpc.CallOption) (*ListWorkersResponse, error) {
	...
	err := c.cc.Invoke(ctx, BuildQueueState_ListWorkers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *buildQueueStateClient) TerminateWorkers(ctx context.Context, in *TerminateWorkersRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, BuildQueueState_TerminateWorkers_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *buildQueueStateClient) ListDrains(ctx context.Context, in *ListDrainsRequest, opts ...grpc.CallOption) (*ListDrainsResponse, error) {
	...
	err := c.cc.Invoke(ctx, BuildQueueState_ListDrains_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *buildQueueStateClient) AddDrain(ctx context.Context, in *AddOrRemoveDrainRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, BuildQueueState_AddDrain_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *buildQueueStateClient) RemoveDrain(ctx context.Context, in *AddOrRemoveDrainRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, BuildQueueState_RemoveDrain_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedBuildQueueStateServer should be embedded to have
...
func (UnimplementedBuildQueueStateServer) testEmbeddedByValue() {}
...
func RegisterBuildQueueStateServer(s grpc.ServiceRegistrar, srv BuildQueueStateServer) {
	// If the following call pancis, it indicates UnimplementedBuildQueueStateServer was
...
var BuildQueueState_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "bonanza.buildqueuestate.BuildQueueState",
	...
	Metadata: "bonanza.build/pkg/proto/buildqueuestate/buildqueuestate.proto",
}
