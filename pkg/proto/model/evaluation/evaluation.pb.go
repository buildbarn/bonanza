...
func (x *Graphlet) GetEvaluationInline() *Evaluation {
	if x != nil {
		if x, ok := x.Evaluation.(*Graphlet_EvaluationInline); ok {
			return x.EvaluationInline
		}
	}
	return nil
}
...
func (x *Graphlet) GetEvaluationExternal() *core.DecodableReference {
	if x != nil {
		if x, ok := x.Evaluation.(*Graphlet_EvaluationExternal); ok {
			return x.EvaluationExternal
		}
	}
	return nil
}
...
type isGraphlet_Evaluation interface {
	isGraphlet_Evaluation()
}
...
func (*Graphlet_EvaluationInline) isGraphlet_Evaluation() {}

func (*Graphlet_EvaluationExternal) isGraphlet_Evaluation() {}
...
func (*Result) Descriptor() ([]byte, []int) {
	return file_bonanza_build_pkg_proto_model_evaluation_evaluation_proto_rawDescGZIP(), []int{6}
}
...
func (*Evaluations_Leaf) Descriptor() ([]byte, []int) {
	return file_bonanza_build_pkg_proto_model_evaluation_evaluation_proto_rawDescGZIP(), []int{3, 1}
}
...
func (x *Result_Failure) Reset() {
	*x = Result_Failure{}
	mi := &file_bonanza_build_pkg_proto_model_evaluation_evaluation_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Result_Failure) Descriptor() ([]byte, []int) {
	return file_bonanza_build_pkg_proto_model_evaluation_evaluation_proto_rawDescGZIP(), []int{6, 0}
}
...
const file_bonanza_build_pkg_proto_model_evaluation_evaluation_proto_rawDesc = "" +
	...
	"\x1fdirect_variable_dependency_keys\x18\x02 \x03(\v2\x1e.bonanza.model.evaluation.KeysR\x1cdirectVariableDependencyKeys\"\xd2\x02\n" +
	"\bGraphlet\x12S\n" +
	"\x11evaluation_inline\x18\x01 \x01(\v2$.bonanza.model.evaluation.EvaluationH\x00R\x10evaluationInline\x12\x84\x01\n" +
	"\x13evaluation_external\x18\x02 \x01(\v2&.bonanza.model.core.DecodableReferenceB)\xea\xd7 %\x12#bonanza.model.evaluation.EvaluationH\x00R\x12evaluationExternal\x12\\\n" +
	"\x16dependency_evaluations\x18\x03 \x03(\v2%.bonanza.model.evaluation.EvaluationsR\x15dependencyEvaluationsB\f\n" +
	"\n" +
	"evaluation\"\xba\x03\n" +
	"\vEvaluations\x12@\n" +
	...
	"\x06Result\x12B\n" +
	"\afailure\x18\x01 \x01(\v2(.bonanza.model.evaluation.Result.FailureR\afailure\x12\x81\x01\n" +
	"\x12outcomes_reference\x18\x02 \x01(\v2&.bonanza.model.core.DecodableReferenceB*\xea\xd7 &\x1a$bonanza.model.evaluation.EvaluationsR\x11outcomesReference\x1ax\n" +
	"\aFailure\x12A\n" +
...
var file_bonanza_build_pkg_proto_model_evaluation_evaluation_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
var file_bonanza_build_pkg_proto_model_evaluation_evaluation_proto_goTypes = []any{
	...
	(*Graphlet)(nil),                // 2: bonanza.model.evaluation.Graphlet
	(*Evaluations)(nil),             // 3: bonanza.model.evaluation.Evaluations
	(*Action)(nil),                  // 4: bonanza.model.evaluation.Action
	(*Progress)(nil),                // 5: bonanza.model.evaluation.Progress
	(*Result)(nil),                  // 6: bonanza.model.evaluation.Result
	(*Keys_Parent)(nil),             // 7: bonanza.model.evaluation.Keys.Parent
	(*Evaluations_Parent)(nil),      // 8: bonanza.model.evaluation.Evaluations.Parent
	(*Evaluations_Leaf)(nil),        // 9: bonanza.model.evaluation.Evaluations.Leaf
	(*Progress_EvaluatingKey)(nil),  // 10: bonanza.model.evaluation.Progress.EvaluatingKey
	(*Result_Failure)(nil),          // 11: bonanza.model.evaluation.Result.Failure
	(*core.Any)(nil),                // 12: bonanza.model.core.Any
...
var file_bonanza_build_pkg_proto_model_evaluation_evaluation_proto_depIdxs = []int32{
	12, // 0: bonanza.model.evaluation.Keys.leaf:type_name -> bonanza.model.core.Any
	7,  // 1: bonanza.model.evaluation.Keys.parent:type_name -> bonanza.model.evaluation.Keys.Parent
	12, // 2: bonanza.model.evaluation.Evaluation.value:type_name -> bonanza.model.core.Any
	0,  // 3: bonanza.model.evaluation.Evaluation.direct_variable_dependency_keys:type_name -> bonanza.model.evaluation.Keys
	1,  // 4: bonanza.model.evaluation.Graphlet.evaluation_inline:type_name -> bonanza.model.evaluation.Evaluation
	13, // 5: bonanza.model.evaluation.Graphlet.evaluation_external:type_name -> bonanza.model.core.DecodableReference
	3,  // 6: bonanza.model.evaluation.Graphlet.dependency_evaluations:type_name -> bonanza.model.evaluation.Evaluations
	9,  // 7: bonanza.model.evaluation.Evaluations.leaf:type_name -> bonanza.model.evaluation.Evaluations.Leaf
	8,  // 8: bonanza.model.evaluation.Evaluations.parent:type_name -> bonanza.model.evaluation.Evaluations.Parent
	13, // 9: bonanza.model.evaluation.Action.overrides_reference:type_name -> bonanza.model.core.DecodableReference
	0,  // 10: bonanza.model.evaluation.Action.requested_keys:type_name -> bonanza.model.evaluation.Keys
	10, // 11: bonanza.model.evaluation.Progress.oldest_evaluating_keys:type_name -> bonanza.model.evaluation.Progress.EvaluatingKey
	11, // 12: bonanza.model.evaluation.Result.failure:type_name -> bonanza.model.evaluation.Result.Failure
	13, // 13: bonanza.model.evaluation.Result.outcomes_reference:type_name -> bonanza.model.core.DecodableReference
	13, // 14: bonanza.model.evaluation.Keys.Parent.reference:type_name -> bonanza.model.core.DecodableReference
	13, // 15: bonanza.model.evaluation.Evaluations.Parent.reference:type_name -> bonanza.model.core.DecodableReference
	2,  // 16: bonanza.model.evaluation.Evaluations.Leaf.graphlet:type_name -> bonanza.model.evaluation.Graphlet
	12, // 17: bonanza.model.evaluation.Progress.EvaluatingKey.key:type_name -> bonanza.model.core.Any
	14, // 18: bonanza.model.evaluation.Progress.EvaluatingKey.first_evaluation_start:type_name -> google.protobuf.Timestamp
	14, // 19: bonanza.model.evaluation.Progress.EvaluatingKey.current_evaluation_start:type_name -> google.protobuf.Timestamp
	12, // 20: bonanza.model.evaluation.Result.Failure.stack_trace_keys:type_name -> bonanza.model.core.Any
	15, // 21: bonanza.model.evaluation.Result.Failure.status:type_name -> google.rpc.Status
...
func file_bonanza_build_pkg_proto_model_evaluation_evaluation_proto_init() {
	...
	file_bonanza_build_pkg_proto_model_evaluation_evaluation_proto_msgTypes[2].OneofWrappers = []any{
		(*Graphlet_EvaluationInline)(nil),
		(*Graphlet_EvaluationExternal)(nil),
	}
	file_bonanza_build_pkg_proto_model_evaluation_evaluation_proto_msgTypes[3].OneofWrappers = []any{
